          ...
          {faqQuestions.map((item, idx: number) => (
            ...
            >
              <AccordionTrigger className="flex w-full cursor-pointer items-start justify-between gap-5 p-0">
                <span className="tex-[20px] flex h-[45px] w-[56px] items-center justify-center rounded-[100%] bg-[#EDEEF0] data-[state=open]:bg-white hover:bg-white font-[500] text-[#002B6B]">
                  0{idx + 1}
                </span>
